...
**Check for context first:**
If relevant project context file exists, read it before asking questions.
...
| File | Description |
|--------|-------------|
| `.shipmate/context/architecture.md` | Project architecture |
| `.shipmate/context/domain.md` | Project domain |
| `.shipmate/context/mission.md` | Project mission |
| `.shipmate/context/project-info.md` | Project information |
| `.shipmate/context/coding-style.md` | Project coding patterns |
| `.shipmate/context/style-guide.md` | Project style guide |
| `.shipmate/context/git-branching.md` | Branching and merge conventions |
| `.shipmate/context/pull-requests.md` | Project pull request conventions |
| `.shipmate/context/tech-debt.md` | Project tech debt |
...
|-----------|--------|--------|--------|
| Feature flag skill | Implement feature flags | Clean up feature flags | Audit feature flags |
...
- [ ] Listed in manifest.json with correct tags and frameworks
